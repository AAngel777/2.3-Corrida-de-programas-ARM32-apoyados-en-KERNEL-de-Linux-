...
int main() {
    ...
    int cantidad = 20; // Establecemos la cantidad de números impares que queremos mostrar.

    std::cout << "Los primeros 20 numeros impares son:" << std::endl;

    while (cantidad > 0) {
        if (contador % 2 != 0) { // Si el número es impar, lo mostramos.
            std::cout << contador << " ";
            cantidad--;
        }
        contador++;
